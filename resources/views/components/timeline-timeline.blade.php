<div class="offset-md-1 col-md-10 timeline">
    ...
    <div data-aos="fade-down" data-aos-easing="linear" data-aos-duration="500">
        <p class="col-md-6 timeline-item left"><span class="yellow">April 16, 2014</span>
    ...
    <div data-aos="fade-down" data-aos-easing="linear" data-aos-duration="500">
        <p class="offset-md-6 col-md-6 timeline-item">
            ...
            by the ferry crew. There are no evacuation announcement made to the passengers until 30 minutes after the call. Instead, the announcement told the passengers to stay where they are and to not move.
        </p>
